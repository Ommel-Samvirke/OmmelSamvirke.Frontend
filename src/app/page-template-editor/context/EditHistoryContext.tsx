...
import { useUndoRedo } from '@/app/page-template-editor/hooks/useUndoRedo';
...
export const EditHistoryContextProvider = (props: EditHistoryContextProviderProps) => {
    ...
    const isUndoCapacityEmpty = useCallback((layout: Layout) => {
        switch (layout) {
            case Layout.DESKTOP:
    ...
    const isRedoCapacityEmpty = useCallback((layout: Layout) => {
        switch (layout) {
            case Layout.DESKTOP:
    ...
    const updateBuffers = useCallback((snapshot: ContentBlockType[], layout: Layout) => {
        switch (layout) {
            case Layout.DESKTOP:
