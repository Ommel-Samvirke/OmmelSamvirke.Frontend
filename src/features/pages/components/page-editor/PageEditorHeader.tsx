...
const PageEditorHeader = () => {
    ...
    useEffect(() => {
        layoutContext.updateColor(backgroundColor);
    }, [backgroundColor, layoutContext]);
                ...
                <div className={styles.leftContainer}>
                    {!editHistoryContext.isUndoCapacityEmpty(layoutContext.currentLayout) && (
                        <Tooltip title="Fortryd (Ctrl+Z)">
                            <IconButton variant="soft" onClick={() => editHistoryContext.undo()}>
                                <UndoIcon />
                            </IconButton>
                        </Tooltip>
                    )}
                    ...
                    {!editHistoryContext.isRedoCapacityEmpty(layoutContext.currentLayout) && (
                        <Tooltip title="Annuller fortryd (Ctrl+Y)">
                            <IconButton variant="soft" onClick={() => editHistoryContext.redo()}>
                                <RedoIcon />
                            </IconButton>
                        </Tooltip>
                    )}
