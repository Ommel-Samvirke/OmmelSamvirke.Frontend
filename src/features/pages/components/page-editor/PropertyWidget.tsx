...
const PropertyWidget = forwardRef(
    (props: PropertyWidgetProps, ref: ForwardedRef<HTMLDivElement>) => {
        return (
            <div
                ref={ref}
                className={styles.PropertyWidget + " content-block-controls"}
            >
                ...
                <div className={styles.Footer}>
                    ...
                    <Button
                        ...
                        color={"danger"}
                        onClick={() => props.deleteContentBlock(props.id)}
                    >
                        Slet
                    </Button>
                </div>
